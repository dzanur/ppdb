                    ...
                    <ul class="navbar-nav ml-auto main-navbar-nav">
                        <?php if (!isset($_SESSION['nisn'])) { ?>
                            <li class="nav-item custom-nav-item">
                                <a class="nav-link custom-nav-link" href="<?= base_url() ?>#home">Home</a>
                            </li>
                            <li class="nav-item custom-nav-item">
                                <a class="nav-link custom-nav-link" href="<?= base_url() ?>#informasi">Informasi</a>
                            </li>
                            <li class="nav-item custom-nav-item">
                                <a class="nav-link custom-nav-link" href="<?= base_url() ?>#alur-pendaftaran">Alur Pendaftaran</a>
                            </li>
                        ...
                        <?php } else { ?>
                            <li class="nav-item custom-nav-item">
                                <a class="nav-link custom-nav-link" href="<?= base_url() ?>#informasi">Profil</a>
                            </li>
                            <li class="nav-item custom-nav-item">
                                <a class="nav-link custom-nav-link" href="<?= base_url() ?>#informasi">Pendaftaran</a>
                            </li>
                            <li class="nav-item header-nav-last-item d-flex align-items-center">
                                <a class="btn btn-brand-03 animated-btn" href="<?= base_url() ?>login">
